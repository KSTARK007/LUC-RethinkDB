...
JSON_INCLUDE_DIR := $(TOP)/third_party/json/single_include
CXXFLAGS += -I$(JSON_INCLUDE_DIR)
...
RT_LDFLAGS += -L$(RDMA_BUILD_DIR) -linfinity -libverbs
RT_CXXFLAGS := $(CXXFLAGS) $(RE2_INCLUDE) $(PROTOBUF_INCLUDE) $(BOOST_INCLUDE) $(QUICKJS_INCLUDE) $(CURL_INCLUDE) $(CRYPTO_INCLUDE) $(Z_INCLUDE) -w
